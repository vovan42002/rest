...
public class ChildController {
    ...
    @GetMapping("/getChildId")
    public Long getChildId(@RequestParam(name = "idParent") Long idParent, @RequestParam(name = "name") String name){
        return childService.getChildId(idParent,name);
    }

    @GetMapping("/getGeo")
    public String getGeo (@RequestParam(name = "idChild") Long idChild) {
        return childService.getGeoChild(idChild);
    }

    @PutMapping("/updateLocation")
    public String updateLocation (@RequestParam(name = "location") String location,
                                  @RequestParam("idChild") Long idChild){
        return childService.location(location,idChild);
    }
    @GetMapping("/getLocation")
    public String getLocation(@RequestParam(name = "idChild") Long idChild){
        return childService.getLocation(idChild);
    }
}
